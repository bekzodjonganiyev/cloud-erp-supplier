...
<template>
  ...
  <div class="min-h-screen bg-gray-900 w-72">
    <div class="flex flex-col fixed">
      ...
      <!-- Something -->
      <div class="flex items-center justify-between bg-gray-700 rounded h-14 w-48 px-6 m-4">
        <!-- Someting info -->
        <div class>
          <h2 class="text-white text-base">Acme Inc</h2>
      ...
      <div class="flex flex-col text-slate-300 m-4 ml-10 w-36 sm:">
        <RouterLink to="/dashboard" class="font-semibold flex mb-7">
          ...
          <span class="d-flex block">Dashboard</span>
        </RouterLink>
